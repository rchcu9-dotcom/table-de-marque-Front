...
export default function HexBadge({ name, imageUrl, size = 52 }: Props) {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "absolute inset-0 rounded-full bg-gradient-to-br from-blue-500/30 via-emerald-400/20 to-slate-700/40 blur-sm",
        )}
      />
      <div
        className="relative overflow-hidden rounded-full ring-2 ring-slate-800"
        style={{
          width: dimension,
          height: dimension,
          background:
