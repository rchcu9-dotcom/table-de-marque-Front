...
export default function MatchDetailPage() {
    ...
    if (isLoading) {
        return (_jsxs("div", { className: "flex items-center gap-3 text-slate-300 text-sm", children: [_jsx(Spinner, {}), _jsx("span", { children: "Chargement du match..." })] }));
    }
    if (isError || !data) {
