...
export default function HomePage() {
  ...
  const momentumTitle = React.useMemo(() => {
    ...
    const competitionLabel = first.competitionType === "3v3" ? "Tournoi 3v3" : first.competitionType === "challenge" ? "Challenge" : "Tournoi 5v5";
    const phaseLabel = first.phase || (first.pouleName?.match(/brassage/i) ? "Brassage" : first.pouleName?.match(/qualification/i) ? "Qualification" : first.pouleName?.match(/final/i) ? "Finales" : undefined);
  ...
  const momentumPGTitle = React.useMemo(() => {
    ...
    const competitionLabel = first.competitionType === "3v3" ? "Tournoi 3v3" : first.competitionType === "challenge" ? "Challenge" : "5v5";
    const pouleLabel = first.pouleName;
